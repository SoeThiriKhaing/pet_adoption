...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthenticationInitial value)?  initial,TResult Function( AuthenticationAuthenticated value)?  authenticated,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthenticationInitial value)  initial,required TResult Function( AuthenticationAuthenticated value)  authenticated,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthenticationInitial value)?  initial,TResult? Function( AuthenticationAuthenticated value)?  authenticated,}){
final _that = this;
switch (_that) {
case AuthenticationInitial() when initial != null:
return initial(_that);case AuthenticationAuthenticated() when authenticated != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( UserEntity user)?  authenticated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthenticationInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( UserEntity user)  authenticated,}) {final _that = this;
switch (_that) {
case AuthenticationInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( UserEntity user)?  authenticated,}) {final _that = this;
switch (_that) {
case AuthenticationInitial() when initial != null:
return initial();case AuthenticationAuthenticated() when authenticated != null:
return authenticated(_that.user);case _:
